...
export const SettingsIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.008 1.13-1.226a11.95 11.95 0 013.34 0c.57.218 1.04.684 1.13 1.226l.095.562a11.95 11.95 0 003.34 0l.562-.095c.542-.09 1.008.56 1.226 1.13a11.95 11.95 0 010 3.34l-.095.562c-.09.542.56 1.008 1.226 1.13a11.95 11.95 0 010 3.34c-.218.57-.684 1.04-1.226 1.13l-.562.095a11.95 11.95 0 00-3.34 0l-.095.562c-.09.542-.56 1.008-1.13 1.226a11.95 11.95 0 01-3.34 0c-.57-.218-1.04-.684-1.13-1.226l-.095-.562a11.95 11.95 0 00-3.34 0l-.562.095c-.542.09-1.008-.56-1.226-1.13a11.95 11.95 0 010-3.34l.095-.562c.09-.542-.56-1.008-1.226-1.13a11.95 11.95 0 010-3.34c.218-.57.684-1.04 1.226-1.13l.562-.095a11.95 11.95 0 003.34 0l.095-.562z" />
...
export const ReceiptIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12v.75m0 3v.75m0 3v.75m0 3V18m-3 .75h18A2.25 2.25 0 0021 16.5V7.5A2.25 2.25 0 0018.75 5.25H5.25A2.25 2.25 0 003 7.5v9A2.25 2.25 0 005.25 18.75h1.5" />
  </svg>
);
