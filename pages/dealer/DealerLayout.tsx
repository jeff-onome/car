...
import { DashboardIcon, ListingIcon, PlusCircleIcon, LogOutIcon, ArrowLeftIcon } from '../../components/IconComponents';
...
const DealerLayout: React.FC = () => {
  ...
  const sidebarLinks = (
      <>
        <NavLink to="/dealer/dashboard" className={navLinkClasses} end>
            <DashboardIcon className="h-5 w-5" />
            <span>Dashboard</span>
        </NavLink>
        <NavLink to="/dealer/listings" className={navLinkClasses} end>
            <ListingIcon className="h-5 w-5" />
            <span>My Listings</span>
        </NavLink>
        <NavLink to="/dealer/listings/add" className={navLinkClasses}>
