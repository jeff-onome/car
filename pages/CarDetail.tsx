...
import { FuelIcon, GaugeIcon, TransmissionIcon, ArrowLeftIcon, HeartIcon, ShieldCheckIcon } from '../components/IconComponents';
...
const CarDetail: React.FC = () => {
  ...
  const { user } = useAuth();
  const { favorites, toggleFavorite, addRecentlyViewed } = useUserData();
  ...
  const handleScheduleClick = () => {
    ...
    if (user.verificationStatus !== 'Verified') {
      ...
      alert(`Scheduling test drive for ${car.make} ${car.model}...`);
    }
  };
      ...
      >
        <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">
                To ensure the security of all transactions, you must verify your account before scheduling a test drive or making a purchase.
            </p>
            <button
                onClick={() => {
