...
import { DashboardIcon, ListingIcon, LogOutIcon, ArrowLeftIcon, UsersIcon, GlobeAltIcon, PlusCircleIcon, MenuIcon, ReceiptIcon } from '../../components/IconComponents';
...
const SuperAdminLayout: React.FC = () => {
  ...
  const sidebarContent = (onLinkClick?: () => void) => (
      <>
        ...
        <NavLink to="/superadmin/dashboard" className={navLinkClasses} end onClick={onLinkClick}>
            <DashboardIcon className="h-5 w-5" />
            <span>Dashboard</span>
        </NavLink>
        <NavLink to="/superadmin/users" className={navLinkClasses} end onClick={onLinkClick}>
            <UsersIcon className="h-5 w-5" />
            <span>Manage Users</span>
        </NavLink>
        <NavLink to="/superadmin/listings" className={navLinkClasses} end onClick={onLinkClick}>
            <ListingIcon className="h-5 w-5" />
            <span>Manage Listings</span>
        </NavLink>
        <NavLink to="/superadmin/analytics" className={navLinkClasses} end onClick={onLinkClick}>
            <ReceiptIcon className="h-5 w-5" />
            <span>Sales Analytics</span>
        </NavLink>
         <NavLink to="/superadmin/listings/add" className={navLinkClasses} onClick={onLinkClick}>
            <PlusCircleIcon className="h-5 w-5" />
            <span>Add Vehicle</span>
        </NavLink>
        <NavLink to="/superadmin/content" className={navLinkClasses} onClick={onLinkClick}>
