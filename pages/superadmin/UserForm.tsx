...
export type UserFormData = Omit<User, 'address' | 'verificationStatus' | 'kycDocument'> & { password?: string };
...
const UserForm: React.FC<UserFormProps> = ({ initialData, onSubmit, isEdit = false }) => {
  // FIX: Added missing 'status' property to align with UserFormData type.
